...
// managed-integrity-v1: S79MdkLxSuj
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-brave", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-brave")
        description.set("kotlin-web-brave")
        url.set("https://github.com/wabbit-corp/kotlin-web-brave")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-brave")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-brave.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-brave.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-brave"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.web.brave"
        compileSdk = 34
        minSdk = 26
    }
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-brave/tree/master/src")
