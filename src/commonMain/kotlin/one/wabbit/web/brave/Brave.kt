...
// discussions	Discussions	Discussions clusters aggregated from forum posts that are relevant to the
// query.
...
// show_strict_warning	bool	Whether there is more content available for query, but the response was
// restricted due to safesearch.
...
// product_cluster	list [ ProductReview ]	A list of products and reviews that are found on the web
// search result page.
...
// creative_work	CreativeWork	Aggregated information on the creative work found on the web search
// result.
// music_recording	MusicRecording	Aggregated information on music recording found on the web search
// result.
// review	Review	Aggregated information on the review found on the web search result.
// software	Software	Aggregated information on a software product found on the web search result
// page.
...
//          "description": "<strong>Making</strong> fresh <strong>gluten</strong>
// <strong>free</strong> <strong>pasta</strong> at home is a labor of love, but it&#x27;s a simple
// process with the right guidance. Find out how!",
//          "thumbnail": {
//            "src":
// "https://imgs.search.brave.com/0gBrCVNOlAIci0sqogMjHvUPh99OcPqP6PbrqR33t1A/rs:fit:200:200:1/g:ce/aHR0cHM6Ly9nbHV0/ZW5mcmVlb25hc2hv/ZXN0cmluZy5jb20v/d3AtY29udGVudC91/cGxvYWRzLzIwMTYv/MTEvc3F1YXJlLWxp/bmd1aW5lLWZvci1o/b21lcGFnZS5qcGc",
//            "original":
// "https://glutenfreeonashoestring.com/wp-content/uploads/2016/11/square-linguine-for-homepage.jpg"
//          },
//          "url": "https://glutenfreeonashoestring.com/gluten-free-pasta-recipe/",
//          "domain": "glutenfreeonashoestring.com",
//          "favicon":
// "https://imgs.search.brave.com/R7q60VyJ2ocggVCYaKm-ji7XWCDOBQSBAWfrTk8-zE4/rs:fit:32:32:1/g:ce/aHR0cDovL2Zhdmlj/b25zLnNlYXJjaC5i/cmF2ZS5jb20vaWNv/bnMvNGZhZTg5MzMw/ODlhY2RmYjFhZjE1/MmIxN2Q2YzdmZjQz/ODhhNTVhYzMyYTZj/MDZiYTQ0ZjI1MmJm/YjE3MGRiYS9nbHV0/ZW5mcmVlb25hc2hv/ZXN0cmluZy5jb20v",
//          "time": "50:00",
//          "prep_time": "45:00",
//          "cook_time": "05:00",
//          "ingredients": "2 cups all purpose gluten free flour blend ((I like Better Batter here;
// click through for details) plus more for dusting), 1 teaspoon xanthan gum (omit if your blend
// already contains it), 5 tablespoons Expandex modified tapioca starch ( (or replace with an equal
// amount of tapioca starch) (See Recipe Notes)), 1/2 teaspoon kosher salt, 2  eggs (at room
// temperature, beaten), 2  egg yolks (at room temperature, beaten), 1 tablespoon extra virgin olive
// oil, 1/3 cup warm water (plus more, as necessary)",
//          "instructions": [
//            {
//              "text": "In the bowl of a food processor fitted with the steel blade, place the
// flour, xanthan gum, Expandex (or tapioca starch), salt, olive oil, eggs and egg yolks, and pulse
// until combined.",
//              "name": "In the bowl of a food processor fitted with the steel blade, place the
// flour, xanthan gum, Expandex (or tapioca starch), salt, olive oil, eggs and egg yolks, and pulse
// until combined.",
//              "url":
// "https://glutenfreeonashoestring.com/gluten-free-pasta-recipe/#wprm-recipe-44935-step-0-0",
//              "image": []
//            },
//            {
//              "text": "Add 1/3 cup water to the mixture in the food processor, and process until
// the dough is moistened.",
//              "name": "Add 1/3 cup water to the mixture in the food processor, and process until
// the dough is moistened.",
//              "url":
// "https://glutenfreeonashoestring.com/gluten-free-pasta-recipe/#wprm-recipe-44935-step-0-1",
//              "image": []
//            },
//            {
//              "text": "Turn on the food processor on low speed, remove the hopper and add more
// water very slowly until the dough clumps to one side of the food processor.",
//              "name": "Turn on the food processor on low speed, remove the hopper and add more
// water very slowly until the dough clumps to one side of the food processor.",
//              "url":
// "https://glutenfreeonashoestring.com/gluten-free-pasta-recipe/#wprm-recipe-44935-step-0-2",
//              "image": []
//            }
//          ],
//          "servings": 1,
...
//            "thumbnail": {
//              "src":
// "https://imgs.search.brave.com/PqP7eMmAeSAKS5xt7URuLRXMQnnaIJcszcI4h3zlyuA/rs:fit:200:200:1/g:ce/aHR0cHM6Ly9tZWRp/YXZpbmUtcmVzLmNs/b3VkaW5hcnkuY29t/L2ltYWdlL3VwbG9h/ZC9zLS10aHo2Vmg3/Si0tL2NfbGltaXQs/Zl9hdXRvLGZsX2xv/c3N5LGhfMTA4MCxx/X2F1dG8sd18xOTIw/L3YxNDc5MDU4MDE0/L2czZG11M25iem5t/cXl3aW5kcTJlLmpw/Zw",
//              "original":
// "https://mediavine-res.cloudinary.com/image/upload/s--thz6Vh7J--/c_limit,f_auto,fl_lossy,h_1080,q_auto,w_1920/v1479058014/g3dmu3nbznmqywindq2e.jpg"
//            }
//          }
//        }
@Serializable
...
// coordinates	list [ float ]	A list of coordinates associated with the location. This is a lat long
...
//
// FIELD	TYPE	DESCRIPTION
// current_day	list [ DayOpeningHours ]	The current day opening hours. Can have two sets of opening
// hours.
...
// opens	string	A 24 hr clock time string for the opening time of the business at the particular
// day.
// closes	string	A 24 hr clock time string for the closing time of the business at the particular
// day.
@Serializable
...
sealed class ProductOrReview {
    class Serializer : KSerializer<ProductOrReview> {
        override val descriptor: SerialDescriptor =
            buildClassSerialDescriptor("ProductOrReview") {
...
@Serializable(with = ViewCount.Serializer::class)
@JvmInline
value class ViewCount(val value: Int) {
    class Serializer : KSerializer<ViewCount> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor("ViewCount", PrimitiveKind.INT)
        ...
        override fun deserialize(decoder: Decoder): ViewCount {
            ...
            if (element is JsonPrimitive) {
                ...
                if (value.endsWith("K")) {
                    ...
                    return ViewCount(
                        value.removeSuffix("M").toIntOrNull() ?: value.toInt() * 1_000_000
                    )
                }
